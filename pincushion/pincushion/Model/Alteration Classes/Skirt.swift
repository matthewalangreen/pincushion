...
// MARK:- Superclass
class Skirt : Codable, AlterationType {
    var minCost: Float
    var maxCost: Float
...
// MARK:- Skirt Subclasses
class OverOrUnderBustle : Skirt {
    override var name: String { return "Over/under bustle" }
    override var costDetails: String { return "per point" }
    override var costUnit: String { return "point(s)" }
...
class AddWristLoopForTrain : Skirt {
    override var name: String { return "Add wrist loop for train" }
...
class SewInSlip : Skirt {
    override var name: String { return "Sew in slip" }
    override var costUnit: String { return String() }
    override var units: Int { return 1 }
    override var secondaryCost: Float { return 0.0 }
    override var secondaryCostDetails: String { return String() }
...
class AddAppliquesSkirt : Skirt {
    override var name: String { return "Add Appliques (skirt)" }
