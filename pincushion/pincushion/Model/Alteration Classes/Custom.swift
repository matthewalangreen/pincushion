...
//  pincushion
//
//  Created by Matt Green on 6/12/19.
...
// MARK:- Superclass
class Custom : Codable, AlterationType {
    var minCost: Float
    var maxCost: Float
...
class CustomAlteration : Custom {
    override var name: String { return "Custom Alteration" }
    override var costDetails: String { return "edit details in \"Review Contract\"" }
    override var costUnit: String { return "" }
