...
// MARK:- Superclass
class Neckline : Codable, AlterationType {
    var minCost: Float
    var maxCost: Float
...
// MARK:- Neckline Subclasses

class ReshapeOrRestyleNeckline : Neckline {
    override var name: String { return "Reshape/restyle neckline" }
